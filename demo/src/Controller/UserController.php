...
class UserController extends AbstractController
{
    ...
    /**
     * @Route("/dashboard/users", name="dashboardUsers")
     */
    public function goToUsers(): Response
    {
        return $this->redirectToRoute('AfficherUsers');
    }
     ...
     * @return Response
     * @route("dashboard/users/AfficherUsers", name="AfficherUsers")
     */
     ...
     * @param UserRepository $repository
     * @return Response
     * @route("dashboard/users/ProfilBack/{id}", name="ProfilBack")
     */
    ...
    /**
     * @route("dashboard/users/SupprimerUser/{id}",name="SupprimerUser")
     */
     ...
     * @return Response
     * @route("dashboard/users/AjouterUser", name="AjouterUser")
     */
    ...
    /**
     * @route ("dashboard/users/ModifierUser/{id}",name="ModifierUser")
     */
    ...
    /**
     * @Route("/activateAccount/{token}", name="ConfirmerCompte")
     */
